...
muziekwijn <- read_csv("../datasets/MuziekWijn.csv", 
...
Als toetje bekijken we nog eens de *waffle* package, die ook een interessante vorm van grafiek kan genereren, doch misschien eerder iets meer commerciële waarde.
...
Er is dus wel degelijk een significant verband tussen het afspelen van een type muziek en het kopen van een type wijn. 
