...
Als je de dichtheidsfunctie op deze grafiek zou plotten, dan zal je een vlakke lijn rond het nulpunt krijgen. De schaal op de y-as voor de dichtheidsfunctie is immers veel kleiner dan die van het histogram (vergelijk met de plot van de dichtheidsfunctie). Daarom moeten we de dichtheidsfunctie mee schalen met het histogram. Als je een histogram tekent, dan kan je de gebruikte schalingswaarden eruit opvragen:
...
# Teken een histogram en hou het als een "object" bij.
histogram <- hist(observations)

# Zoek de schalingsfactor op voor de dichtheidsfunctie
scale_factor <- (histogram$counts[1] / histogram$density[1])

# Bereken y-waarden voor de dichtheidsfunctie
y <- dnorm(x, m, s) * scale_factor
