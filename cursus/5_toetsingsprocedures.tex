...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item Waarde toetsingsgrootheid bepalen. Bij de $z$-toets berekenen we het steekproefgemiddelde $\overline{x}$. Volgens de centrale limietstelling geldt dat de verdeling van het steekproefgemiddelde, $M$ normaal verdeeld is met parameters:
    
    \[ M \sim Nor(\mu = 27, \frac{\sigma}{\sqrt{n}}) \]
    
    De z-score voor het steekproefgemiddelde is:
...
\begin{example}
  ...
  \begin{enumerate}
    \item Formuleren van de hypothesen.
