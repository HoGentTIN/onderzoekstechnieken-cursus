...
%-----------------------------------------------------------------------------
% Packages en instellingen specifiek voor deze cursus
%-----------------------------------------------------------------------------
...
\author{Dr. Jens Buysse, Wim {De Bruyn}, Wim Goedertier, Bert {Van Vreckem}}
...
\include{aan-de-slag}
\include{onderzoeksproces}
\include{analyse-1-variabele}
\include{steekproefonderzoek}
\include{toetsingsprocedures}
\include{analyse-2-variabelen}
\include{chi-kwadraat-toets}
\include{tijdreeksen}
