...
Merk op dat we hier niet expliciet vooraf een significantieniveau gekozen hebben. Voor $\alpha = 0,1$, $0,5$ of zelfs $0,1$, kunnen we echter dezelfde conclusie trekken.
