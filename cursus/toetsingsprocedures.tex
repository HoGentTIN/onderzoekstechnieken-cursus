...
\end{verbatim}
    ...
    \sout{Je kan uit de uitvoer van de \texttt{t.test}-functie ook het kritieke gebied aflezen: $[0,3245133; +\infty[$. Het steekproefgemiddelde $0,4564444$ ligt in het kritieke gebied, wat eveneens leidt tot de conclusie dat de nulhypothese kan verworpen worden.}
  \end{enumerate}
...
\end{verbatim}
  ...
  \sout{De teststatistiek $t = -3,4456$ ligt binnen het verwerpingsgebied $]-\infty; -6,044949]$.}
...
kunnen we met 95\% procent zekerheid kunnen dat het verschil van de \textit{\'echte} gemiddelden ($\mu_1-\mu_2$)
...
\end{verbatim}
  ...
  \sout{De teststatistiek $t = 4,4721$ ligt binnen het verwerpingsgebied $[1,180207; +\infty]$.}

  \textbf{Ter info}: Bij 95\% van de ``paren'' van deze gepaarde t-test,
