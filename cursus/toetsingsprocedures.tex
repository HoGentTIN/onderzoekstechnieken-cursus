...
\begin{example}
  ...
  Ze gaan dit onderzoeken en voeren een steekproef uit bij $n = 30$ superhelden. In deze steekproef is het gemiddelde $\overline{x} = 3,483$ is. Kan hieruit besloten worden dat superhelden gemiddeld meer dan 3,3 mensen per dag redt?
...
\begin{definition}[Betrouwbaarheidsniveau]
  Naast
\end{definition}
