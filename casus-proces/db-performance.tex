...
\Abstract{ Aan de hand van een concrete casus wordt een typisch onderzoeksproces doorlopen. De onderzoeksvraag is onderdeel van de opdracht: het vergelijken van de performantie van verschillende database-systemen. Eerst wordt er aan de hand van een literatuurstudie een beeld gevormd van de stand van zaken in het onderzoeksdomein. Ook wordt de onderzoeksvraag verder gespecifieerd. Vervolgens wordt een experiment opgezet om een antwoord te formuleren op de onderzoeksvraag. De resultaten worden gevisualiseerd en geanalyseerd. Tenslotte wordt het gehele verloop samengevat in een artikel. }
...
\begin{itemize}
	...
	\item Tekst rapportering resultaten.
\end{itemize}
...
Het resultaat wordt beoordeeld naargelang het voldoet aan de hierboven opgesomde richtlijnen. In principe krijgen alle teamleden dezelfde beoordeling, tenzij uit de Github logs blijkt dat iemand er -in de goede of de slechte zin- uit springt. Studenten die hun bijdrage niet kunnen aantonen, krijgen 0. 
