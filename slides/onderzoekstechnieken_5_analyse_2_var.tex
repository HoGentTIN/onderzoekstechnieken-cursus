...
\begin{frame}{Student vs werknemer}
  ...
  \begin{figure}
    \centering
    \only<1>{\includegraphics[height=0.6\textheight]{img/2var-barplot-gemiddeld-bedrag}}
    \only<2>{\includegraphics[height=0.6\textheight]{img/2var-boxplot-klanttype-bedrag}}
  \end{figure}
