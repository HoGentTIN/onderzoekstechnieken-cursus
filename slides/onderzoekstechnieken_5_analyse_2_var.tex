  ...
  \begin{frame}
    ...
    \note{Onderzoeken die hier gevoerd zijn:
      ...
      \begin{itemize}
        ...
        \item Arnd Leike of the Ludwig Maximilians University receives one of the awards - which are given for research that cannot or should not be repeated - for demonstrating that beer froth obeys the mathematical law of exponential decay.
      \end{itemize}}
    \end{frame}
