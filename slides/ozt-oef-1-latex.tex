%%----------------------------------------------------------------------------
%% Onderzoekstechnieken: Intro LaTeX
%%----------------------------------------------------------------------------
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \column{.33\textwidth}
    \begin{center}
      \only<1-3>{\includegraphics[width=\textwidth]{oef1-01}}
      \only<4->{\includegraphics[width=\textwidth]{oef1-02}}
    \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=.6\textheight]{oef1-03}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=.6\textheight]{oef1-04}
  \end{center}
...
\begin{frame}
  ...
  \uncover<1->{%
    \begin{center}
      \includegraphics[height=.5\textheight]{oef1-05}
  \end{center}}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=.6\textheight]{oef1-06}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[c]
    ...
    \column{.35\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{oef1-01}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=.7\textwidth]{oef1-07}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=.7\textwidth]{oef1-08}
  \end{center}
  
  \alertbox{HoGent gebruikt de ``APA''-stijl voor de opmaak van bibliografieën \url{https://bib.hogent.be/how-to/bronnen-vermelden/refereren-volgens-apa6th/}}
